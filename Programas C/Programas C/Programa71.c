...
int main()
{
    ...
    apuntador=/*como malloc devuelve void, este char es para convertir el apuntador a tipo char y asignar a apuntador*/(char*)malloc((longitud+1)/*multiplicado*/*sizeof(char));
