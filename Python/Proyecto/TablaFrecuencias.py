...
if lectura==1:
	...
	##ruta ='/Users/ricardo/Desktop/Proyecto/Entrada.txt'
...
while contadorA<len(frecuencia):
	if(contadorA==0):
		...
		contadorA+=1
print("Que tipo de grafica desea que se genere:")
print("1. Histograma\n2. Poligono")
lectura=int(input())
if lectura==1:
	plt.hist(lista,intervalos,histtype='bar',rwidth=0.9,color = 'b')
	plt.xlabel('x')
	plt.ylabel('y')
	plt.title('Histograma')
	plt.show()
elif lectura==2:
	plt.stackplot(mclase,frecuencia, color= 'c')
	plt.xlabel('x')
	plt.ylabel('y')
	plt.title('Poligono')
	plt.show()
